(function (window, document) {
  ...
  KanjiCanvas.strokeColors = new Array(30).fill("#ff79c6");
  ...
  KanjiCanvas.draw = function (id, color) {
    ...
    KanjiCanvas["ctx_" + id].strokeStyle = color ? color : "#ff79c6";
  ...
  KanjiCanvas.findxy = function (res, e, id) {
    ...
    if (res == "down") {
      ...
      var sx = KanjiCanvas["canvas_" + id].width / rect.width;
      var sy = KanjiCanvas["canvas_" + id].height / rect.height;
      ...
      if (
        ...
        KanjiCanvas["currX_" + id] = e.offsetX * sx;
        KanjiCanvas["currY_" + id] = e.offsetY * sy;
      } else {
        KanjiCanvas["currX_" + id] =
          ((touch ? touch.clientX : e.clientX) - rect.left) * sx;
        KanjiCanvas["currY_" + id] =
          ((touch ? touch.clientY : e.clientY) - rect.top) * sy;
      }
      ...
      if (KanjiCanvas["dot_flag_" + id]) {
        KanjiCanvas["ctx_" + id].beginPath();
        KanjiCanvas["ctx_" + id].fillStyle = "#ff79c6";
    ...
    if (KanjiCanvas["canvas_" + id].dataset.strokeNumbers != "false") {
      for (var i = 0; i < KanjiCanvas["recordedPattern_" + id].length; i++) {
        ...
        KanjiCanvas["ctx_" + id].strokeStyle = KanjiCanvas.alterHex(
          KanjiCanvas.strokeColors[i] ? KanjiCanvas.strokeColors[i] : "#333333",
          60,
          "dec"
        );
